          ...
          <Row>
            <Col lg="6">
              <div className="hero__content">
                ...
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sequi consectetur doloremque alias tenetur dolores adipisci commodi facilis placeat, modi quia?</p>
              </div>
            </Col>
        ...
        <Container>
          <Row>
            <Col lg="12">
              ...
              <h2 className="testimonial__title">What our fans about us</h2>
            </Col>
            <Col lg="12">
              <Testimonials />
            </Col>
